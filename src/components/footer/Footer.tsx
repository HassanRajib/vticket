  ...
  <div className="max-w-screen-xl mx-auto md:flex md:justify-between md:items-start">
    ...
    <div className="mb-10 md:mb-0 md:w-1/4">
      <a href="https://flowbite.com/" className="flex items-center">
        <img src="../image/variation.png" className="h-8 me-3" alt="Logo" />
        <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Variation</span>
      </a>
    </div>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:w-3/4">
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="https://flowbite.com/" className="hover:underline">Variation IT™</a>. All Rights Reserved.
          </span>
