...
const Slide = ({ slide, index, current, handleSlideClick }: SlideProps) => {
  ...
  return (
    <div className="[perspective:800px] [transform-style:preserve-3d]">
      <li
        ref={slideRef}
        className="flex flex-1 flex-col items-center justify-center relative text-center text-white opacity-100 transition-all duration-300 ease-in-out w-[80vw] sm:w-[60vw] md:w-[40vw] lg:w-[30vw] aspect-[3/4] "
...
export function Carousel({ slides }: CarouselProps) {
  ...
  return (
    <div
      ...
      className="relative w-full max-w-xl h-[60vmin] mx-auto"
